...
from CELP_CyCTR.model.CyCTR import CELPNet
from CELP_CyCTR.util import dataset, transform, config
from CELP_CyCTR.util.util import AverageMeter, intersectionAndUnionGPU
...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='./CELP_CyCTR/config/pascal/pascal_split0_resnet50.yaml',
                        help='config file')
    parser.add_argument('opts', help='see CELP_CyCTR/config/pascal/pascal_split0_resnet50.yaml for all options',
